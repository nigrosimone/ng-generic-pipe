...
import { NgGenericPipe, NgGenericDirective } from 'ng-generic-pipe';
...
@Component({
  ...
  template: `<main>
    ...
    DIRECTIVE:
    <ng-content *ngGenericPipe="let fn; method: testFromDirective">{{
      fn(arg1(), arg2())
    }}</ng-content>
    ...
    DIRECTIVE async:
    <ng-content *ngGenericPipe="let fn; method: testAsync">{{ fn(arg1()) | async }}</ng-content
    ><br /><br />
